...
IO_ATTR void io_print_float(float v);
IO_ATTR void io_print_double(double v);
...
// Debug
IO_ATTR void io_ping(void);
IO_ATTR void io_space(void);
IO_ATTR void debug_A(void);
IO_ATTR void debug_B(void);
IO_ATTR void debug_C(void);
